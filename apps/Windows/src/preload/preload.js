...
contextBridge.exposeInMainWorld("winplate", {
  ...
  onHealthSyncUpdated: (callback) => ipcRenderer.on("health:refresh", (_event, payload) => callback(payload)),
  ...
  getCodexTokenUsage: (options = {}) => ipcRenderer.invoke("codex:token-usage", options),
  getSuperGrokUsage: (options = {}) => ipcRenderer.invoke("supergrok:usage", options),
  getSuperGrokTokenUsage: (options = {}) => ipcRenderer.invoke("supergrok:token-usage", options),
